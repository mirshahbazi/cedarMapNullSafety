...
class _CedarmapsMapState extends State<CedarmapsMap> {
  ...
  late _CedarmapsMapOptions _cedarmapsMapOptions;
...
class _CedarmapsMapOptions {
  _CedarmapsMapOptions({
    ...
    this.compassViewPosition,
    this.compassViewMargins = const Point(0, 0),
  });

  static _CedarmapsMapOptions fromWidget(
      CedarmapsMap map, String? accessToken) {
    return _CedarmapsMapOptions(
      compassEnabled: map.compassEnabled,
      cameraTargetBounds: map.cameraTargetBounds,
      styleString:
          [map.baseUrl! + MapStyleHelper.urlPath(map.style)].join('/') +
              '?token=${map.token}',
